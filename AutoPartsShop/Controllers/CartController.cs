using AutoPartsShop_DataAccess;
using AutoPartsShop_DataAccess.Repository.IRepository;
using AutoPartsShop_Models;
using AutoPartsShop_Models.ViewModels;
using AutoPartsShop_Utility;
using AutoPartsShop_Utility.BrainTree;
using Braintree;
...
namespace AutoPartsShop.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(IApplicationUserRepository userRepo, IWebHostEnvironment webHostEnvironment, IProductRepository prodRepo, 
            IInquiryDetailRepository inqDRepo, IInquiryHeaderRepository inqHRepo, IOrderDetailRepository orderDRepo, IOrderHeaderRepository orderHRepo,
        ...
        public IActionResult IndexPost(IEnumerable<Product> ProdList)
        {
            ...
            {
                shoppingCartList.Add(new ShoppingCart { ProductId = prod.Id, Kits = prod.TempKit });
            }
        ...
        public IActionResult SummaryPost(IFormCollection collection, ProductUserVM ProductUserVM)
        {
            ...
            if (User.IsInRole(WC.AdminRole))
            {
                ...
                OrderHeader orderHeader = new OrderHeader()
                {
                    ...
                    FinalOrderTotal = ProductUserVM.ProductList.Sum(x => x.TempKit * x.Price),
        ...
        {
            HttpContext.Session.Clear();
            TempData[WC.Success] = "All Items have been successfully removed from the shopping cart";
